...
/**
 * Questa pagina è stata unificata con la radice della dashboard (/dashboard).
 * Reindirizziamo automaticamente per mantenere la compatibilità dei link.
 */
export default function LegacyVehiclesPage() {
  redirect('/dashboard');
