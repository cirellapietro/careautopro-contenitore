...
import { Loader2, CheckCircle2, AlertTriangle, Pencil, Trash2 } from 'lucide-react';
    ...
    try {
      ...
      setAllInterventions(results.flat().sort((a, b) => {
        ...
        errorEmitter.emit('permission-error', new FirestorePermissionError({
            ...
            operation: 'list',
            requestResourceData: { context: 'Fetching all interventions for summary page.' }
        }));
    } finally {
      setLoading(false);
    }
