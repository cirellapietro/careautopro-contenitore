...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 53901));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MaintenanceCheckDetailPage)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95155);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12115);
...
const checkSchema = zod__WEBPACK_IMPORTED_MODULE_13__/* .object */ .Ik({
    description: zod__WEBPACK_IMPORTED_MODULE_13__/* .string */ .Yj().min(3, 'La descrizione è obbligatoria.'),
    intervalMileage: zod__WEBPACK_IMPORTED_MODULE_13__/* .coerce */ .au.number().optional(),
    intervalTime: zod__WEBPACK_IMPORTED_MODULE_13__/* .coerce */ .au.number().optional()
});
function MaintenanceCheckDetailContent() {
    ...
    const checkRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(()=>{
        if (isNew || !firestore || !vehicleTypeId || !checkId) return null;
        return (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .doc */ .H9)(firestore, "vehicleTypes/".concat(vehicleTypeId, "/maintenanceChecks"), checkId);
    }, [
        firestore,
        vehicleTypeId,
        checkId,
    ...
    const { data: maintenanceCheck, isLoading: checkLoading } = (0,_firebase__WEBPACK_IMPORTED_MODULE_6__/* .useDoc */ .uN)(checkRef);
    const form = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_14__/* .useForm */ .mN)({
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_15__/* .zodResolver */ .u)(checkSchema),
        defaultValues: {
            description: '',
        ...
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            ...
            children: [
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
                    children: "ID Tipo Veicolo mancante. Torna indietro e riprova."
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_7__/* .Button */ .$, {
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                        ...
                        children: "Torna ai Tipi Veicolo"
                    })
                })
            ]
        });
    ...
    const onSubmit = (values)=>{
        ...
        if (isNew) {
            const checksCollection = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .collection */ .rJ)(firestore, "vehicleTypes/".concat(vehicleTypeId, "/maintenanceChecks"));
            const dataToCreate = {
                ...data,
                vehicleTypeId: vehicleTypeId,
                dataoraelimina: null
            };
            (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .addDoc */ .gS)(checksCollection, dataToCreate).then((newDocRef)=>{
                ...
                router.push("/dashboard/admin/vehicle-types/view?id=".concat(vehicleTypeId));
            }).catch((serverError)=>{
                const permissionError = new _firebase__WEBPACK_IMPORTED_MODULE_6__/* .FirestorePermissionError */ .$9({
                    path: "vehicleTypes/".concat(vehicleTypeId, "/maintenanceChecks"),
                    operation: 'create',
                ...
                toast({
                    variant: 'destructive',
                    title: 'Errore',
                    description: 'Impossibile salvare il controllo.'
                });
            ...
            (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .updateDoc */ .mZ)(checkRef, dataToUpdate).then(()=>{
                toast({
                    title: 'Successo',
                    description: 'Controllo aggiornato.'
                });
                router.push("/dashboard/admin/vehicle-types/view?id=".concat(vehicleTypeId));
            }).catch((serverError)=>{
                const permissionError = new _firebase__WEBPACK_IMPORTED_MODULE_6__/* .FirestorePermissionError */ .$9({
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_7__/* .Button */ .$, {
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                    href: "/dashboard/admin/vehicle-types/view?id=".concat(vehicleTypeId),
                    children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardHeader */ .aR, {
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardTitle */ .ZB, {
                                        children: isNew ? 'Nuovo Controllo Manutenzione' : 'Modifica Controllo'
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardDescription */ .BT, {
                                        children: isNew ? 'Aggiungi un nuovo controllo al piano di manutenzione.' : "Modifica i dettagli del controllo."
                                    })
                                ]
                            }),
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormField */ .zB, {
                                        ...
                                        render: (param)=>{
                                            ...
                                            return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormItem */ .eI, {
                                                children: [
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormLabel */ .lR, {
                                                        children: "Intervallo Chilometrico (km)"
                                                    }),
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormControl */ .MJ, {
                                                    ...
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormDescription */ .Rr, {
                                                        children: "Lascia vuoto se non applicabile."
                                                    }),
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormMessage */ .C5, {})
                                                ]
                                            });
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormField */ .zB, {
                                        ...
                                        render: (param)=>{
                                            ...
                                            return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormItem */ .eI, {
                                                children: [
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormLabel */ .lR, {
                                                        children: "Intervallo Temporale (mesi)"
                                                    }),
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_form__WEBPACK_IMPORTED_MODULE_9__/* .FormControl */ .MJ, {
                                                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_input__WEBPACK_IMPORTED_MODULE_10__/* .Input */ .p, {
                                                            type: "number",
...
function MaintenanceCheckDetailPage() {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Suspense, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(MaintenanceCheckDetailContent, {})
    });
}
...
/******/ __webpack_require__.O(0, [7811,2992,3135,5402,176,197,8470,8441,1255,7358], () => (__webpack_exec__(18515)));
