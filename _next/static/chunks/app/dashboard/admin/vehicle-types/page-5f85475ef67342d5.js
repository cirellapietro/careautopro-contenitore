(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5422],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AdminVehicleTypesPage)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95155);
...
/* harmony import */ var _barrel_optimize_names_Loader2_Pencil_PlusCircle_Trash2_lucide_react__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(74640);
/* harmony import */ var _barrel_optimize_names_Loader2_Pencil_PlusCircle_Trash2_lucide_react__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(13630);
...
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(64269);
...
function AdminVehicleTypesPage() {
    ...
    const [vehicleTypeToDelete, setVehicleTypeToDelete] = (0,react__WEBPACK_IMPORTED_MODULE_7__.useState)(null);
    const vehicleTypesQuery = (0,react__WEBPACK_IMPORTED_MODULE_7__.useMemo)(()=>{
        if (!firestore || (currentUser === null || currentUser === void 0 ? void 0 : currentUser.role) !== 'Amministratore') return null;
        return (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__/* .query */ .P)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__/* .collection */ .rJ)(firestore, 'vehicleTypes'), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__/* .where */ ._M)('dataoraelimina', '==', null));
    }, [
        firestore,
        currentUser
    ]);
    const { data: vehicleTypes, isLoading: vehicleTypesLoading } = (0,_firebase__WEBPACK_IMPORTED_MODULE_2__/* .useCollection */ .Ge)(vehicleTypesQuery);
    ...
    const handleDelete = ()=>{
        ...
        const docRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__/* .doc */ .H9)(firestore, 'vehicleTypes', vehicleTypeToDelete.id);
        const dataToUpdate = {
        ...
        (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__/* .updateDoc */ .mZ)(docRef, dataToUpdate).then(()=>{
            toast({
                title: "Tipo veicolo eliminato",
                description: "Il tipo di veicolo è stato contrassegnato come eliminato."
            });
        }).catch((serverError)=>{
            ...
            toast({
                ...
                description: "Non disponi dei permessi per eliminare questo tipo veicolo."
            });
        }).finally(()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h1", {
                                        ...
                                        children: "Gestione Tipi Veicolo"
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
                                        className: "text-muted-foreground",
                                        children: "Gestisci i tipi di veicolo e i relativi piani di manutenzione."
                                    })
                                ]
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_button__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$, {
                                onClick: ()=>router.push('/dashboard/admin/vehicle-types/view?id=new'),
                                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_card__WEBPACK_IMPORTED_MODULE_4__/* .Card */ .Zp, {
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_card__WEBPACK_IMPORTED_MODULE_4__/* .CardHeader */ .aR, {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_4__/* .CardDescription */ .BT, {
                                        children: "Visualizza e gestisci i tipi di veicolo disponibili nell'applicazione."
                                    })
                                ]
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_4__/* .CardContent */ .Wu, {
                                children: vehicleTypesLoading && !vehicleTypes ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                                    className: "flex h-48 items-center justify-center",
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_Loader2_Pencil_PlusCircle_Trash2_lucide_react__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A, {
                                        className: "h-8 w-8 animate-spin"
                                    })
                                }) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_table__WEBPACK_IMPORTED_MODULE_5__/* .Table */ .XI, {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_table__WEBPACK_IMPORTED_MODULE_5__/* .TableBody */ .BF, {
                                            children: vehicleTypes && vehicleTypes.map((vt)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_table__WEBPACK_IMPORTED_MODULE_5__/* .TableRow */ .Hj, {
                                                    className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_13__.cn)("cursor-pointer", vt.dataoraelimina && 'text-muted-foreground opacity-50'),
                                                    onClick: ()=>!vt.dataoraelimina && router.push("/dashboard/admin/vehicle-types/view?id=".concat(vt.id)),
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_table__WEBPACK_IMPORTED_MODULE_5__/* .TableCell */ .nA, {
                                                            children: [
                                                                vt.averageAnnualMileage.toLocaleString('it-IT'),
                                                                " km"
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_table__WEBPACK_IMPORTED_MODULE_5__/* .TableCell */ .nA, {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$, {
                                                                    ...
                                                                    onClick: (e)=>{
                                                                        e.stopPropagation();
                                                                        router.push("/dashboard/admin/vehicle-types/view?id=".concat(vt.id));
                                                                    },
                                                                    disabled: !!vt.dataoraelimina,
                                                                ...
                                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$, {
                                                                    ...
                                                                    disabled: !!vt.dataoraelimina,
                                                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_Loader2_Pencil_PlusCircle_Trash2_lucide_react__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .A, {
                                                                        className: "h-4 w-4"
                                                                    })
                                                                })
                                                            ]
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_alert_dialog__WEBPACK_IMPORTED_MODULE_9__/* .AlertDialog */ .Lt, {
                open: !!vehicleTypeToDelete,
                onOpenChange: ()=>setVehicleTypeToDelete(null),
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_alert_dialog__WEBPACK_IMPORTED_MODULE_9__/* .AlertDialogHeader */ .wd, {
                            children: [
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_alert_dialog__WEBPACK_IMPORTED_MODULE_9__/* .AlertDialogDescription */ .$v, {
                                    children: [
                                        "Questa azione contrassegner\xe0 il tipo veicolo ",
                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
                                            className: "font-bold",
                                            children: vehicleTypeToDelete === null || vehicleTypeToDelete === void 0 ? void 0 : vehicleTypeToDelete.name
                                        }),
                                        " come eliminato."
                                    ]
                                })
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 38739));
...
/******/ __webpack_require__.O(0, [7811,2992,3135,5402,315,3409,9584,8470,8441,1255,7358], () => (__webpack_exec__(81357)));
