(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[6493],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RoleDetailPage)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95155);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12115);
...
const roleSchema = zod__WEBPACK_IMPORTED_MODULE_13__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_13__/* .string */ .Yj().min(2, 'Il nome è obbligatorio.'),
    description: zod__WEBPACK_IMPORTED_MODULE_13__/* .string */ .Yj().optional()
});
function RoleDetailContent() {
    ...
    const roleRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(()=>{
        if (isNew || !firestore || !roleId) return null;
        return (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .doc */ .H9)(firestore, 'roles', roleId);
    }, [
        firestore,
        roleId,
        isNew
    ]);
    const { data: role, isLoading: roleLoading } = (0,_firebase__WEBPACK_IMPORTED_MODULE_6__/* .useDoc */ .uN)(roleRef);
    const form = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_14__/* .useForm */ .mN)({
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_15__/* .zodResolver */ .u)(roleSchema),
        defaultValues: {
            name: '',
            description: ''
        }
    ...
    const onSubmit = (values)=>{
        ...
        if (isNew) {
            const rolesCollection = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .collection */ .rJ)(firestore, 'roles');
            const dataToCreate = {
                ...values,
                dataoraelimina: null
            };
            (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .addDoc */ .gS)(rolesCollection, dataToCreate).then((newDocRef)=>{
            ...
            (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_4__/* .updateDoc */ .mZ)(roleRef, dataToUpdate).then(()=>{
                toast({
                    title: 'Successo',
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardHeader */ .aR, {
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardTitle */ .ZB, {
                                        children: isNew ? 'Nuovo Ruolo' : 'Modifica Ruolo'
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_card__WEBPACK_IMPORTED_MODULE_8__/* .CardDescription */ .BT, {
                                        children: isNew ? 'Crea un nuovo ruolo per gli utenti.' : "Modifica i dettagli del ruolo: ".concat(role === null || role === void 0 ? void 0 : role.name)
                                    })
                                ]
                            }),
...
function RoleDetailPage() {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Suspense, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(RoleDetailContent, {})
    });
}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 11678));
...
/******/ __webpack_require__.O(0, [7811,2992,3135,5402,176,197,8470,8441,1255,7358], () => (__webpack_exec__(56604)));
