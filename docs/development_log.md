...
# Log di Configurazione CareAutoPro

## Endpoint di Autenticazione
*   **Google Redirect**: Gestito automaticamente da Firebase.
*   **Facebook OAuth Redirect URI**: `https://studio-99874364-880bd.firebaseapp.com/__/auth/handler`
    *   *Stato*: Da inserire nel portale Meta Developers per abilitare l'accesso social.

## Hosting e Domini
*   **URL Predefinito**: `https://studio-99874364-880bd.web.app`
*   **Alias**: `https://studio-99874364-880bd.firebaseapp.com`

## Note Tecniche Eliminazione Logica
*   Tutte le collezioni supportano il campo `dataoraelimina` (ISO String).
*   Le query sono filtrate per `dataoraelimina == null`.
*   L'eliminazione dell'account esegue il `delete()` reale dall'Auth di Firebase per permettere la ri-registrazione, mantenendo però il record storico (logico) nel database Firestore sotto il vecchio UID.
